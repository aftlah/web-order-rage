...
window.SEED_CUSTOMERS = [
  "George","Gin","Yanto","Fellicia","Leo","Theo","Kaninacu","Bimbuy","Bani","Balstot","Ryan","Veno","Endo","Ucok","Luca","Martin","Alan","Gurdo","Pipin","Zein","Namota","Ujang","Trada","Remii","Mahesa","Will","Beren","Aveo","RexieeBoy","LexieeBoy","Ryu","Damon","Park Haji","Melky","Kunyuk","Nopal","Sen","Kayden","Ajovi","Alekk","Abehh","Dyren","Erick","Evan","Grandong","Kuntuy","Leinad","Mangwill","Oslo","Boril","Seins","xKaman","Kim","Jazan"
];
