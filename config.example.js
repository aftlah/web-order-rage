...
window.DISCORD_STORAN_WEBHOOK_URL = "YOUR_DISCORD_STORAN_WEBHOOK_URL_HERE";
window.DISCORD_ABSEN_WEBHOOK_URL = "YOUR_DISCORD_ABSEN_WEBHOOK_URL_HERE";
window.DISCORD_NITIP_CUCI_WEBHOOK_URL = "YOUR_DISCORD_NITIP_CUCI_WEBHOOK_URL_HERE";
